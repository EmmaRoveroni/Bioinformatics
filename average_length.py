...
for position in range(genome_length): # cicle over all positions of the genome
	...
	current_sum += sumlen_change[position]
	if (current_coverage>0): 
		print(current_sum/current_coverage)
	else: #If I have a covergae equal to 0, I need to print something otherwise the position in the genome is not written
		print(-1)
